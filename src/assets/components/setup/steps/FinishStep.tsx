...
import {completeFirstSetup} from "../../../ts/first-setup.ts";
...
export default function FinishStep()
{
    ...
    {
        // Logic to save settings and continue
        console.log("Settings saved, continuing...");
        setIsSaving(true);
        await completeFirstSetup();
        window.location.href = "/"; // Redirect to home page after setup
        setIsSaving(false);
    };
